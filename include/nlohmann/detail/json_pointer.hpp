...
private:
  ...
  */
  template <typename BasicJsonType>
  static void
  flatten(const string_t &reference_string, const BasicJsonType &value,
      ...
      case detail::value_t::array:
        {
          if(value.m_data.m_value.array->empty())
          ...
          else
            {
              ...
              for(std::size_t i = 0; i < value.m_data.m_value.array->size();
                  ++i)
                {
                  flatten(
...
public:
  ...
  /// @sa https://json.nlohmann.me/api/json_pointer/operator_eq/
  JSON_HEDLEY_DEPRECATED_FOR(3.11.2,
