        ...
        case value_t::binary:
          {
            ...
            std::allocator_traits<decltype(alloc)>::deallocate(alloc, binary,
                                                               1);
            break;
          }
...
public:
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/swap/
  void
  swap(typename binary_t::container_type
    ...
    {                                                                          \
      return static_cast<number_integer_t>(lhs.m_data.m_value.number_unsigned) \
        op rhs.m_data.m_value.number_integer;                                  \
          ...
          rhs_type == value_t::number_unsigned)                                \
    {                                                                          \
      return lhs.m_data.m_value.number_integer                                 \
        op static_cast<number_integer_t>(rhs.m_data.m_value.number_unsigned);  \
    }                                                                          \
...
public:
  ...
  static std::vector<std::uint8_t>
  to_ubjson(const basic_json &j, const bool use_size = false,
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/to_ubjson/
  static void
  to_ubjson(const basic_json &j, detail::output_adapter<std::uint8_t> o,
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/to_ubjson/
  static void
  to_ubjson(const basic_json &j, detail::output_adapter<char> o,
            const bool use_size = false, const bool use_type = false)
  {
                               ...
                               // https://github.com/nlohmann/json/pull/679
{
  ...
  */
  bool
  operator()(::nlohmann::detail::value_t lhs,
